...
<template>
  <div class="p-4 h-screen flex flex-col justify-center items-center">
    <div class="grid grid-cols-2 gap-8 w-full content-center">
      <div class="flex flex-col justify-between items-center">
        <div class="w-[60%]">
          ...
          <NuxtButton class="mt-2">Get started</NuxtButton>
          <p class="my-4">
          ...
          <div class="grid grid-cols-4 gap-4 mt-6 content-center align-center">
            <div
              ...
              :key="index"
              class="flex flex-col justify-center items-center bg-white/5 h-[100px] rounded-2xl transition duration-600 opacity-50 cursor-pointer hover:opacity-100 hover:shadow-white-100/10 hover:shadow-2xl"
            >
              <NuxtIcon :name="item.icon" size="32" />
              <div>{{ item.label }}</div>
            </div>
          </div>
        </div>
